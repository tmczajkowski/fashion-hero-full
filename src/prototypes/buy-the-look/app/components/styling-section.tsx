...
export function StylingSection({ styling, onAddToCart, onRate, userRating, outfitImage }: StylingSectionProps) {
  ...
  if (!styling || styling.products.length === 0) {
    return null;
  }
          ...
          <div className="bg-white rounded-lg overflow-hidden">
            ...
            <div className="p-3">
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => { handleRate('positive'); posthog.capture('buy_the_look_like_up'); }}
                ...
                <button
                  onClick={() => { handleRate('negative'); posthog.capture('buy_the_look_like_down'); }}
          ...
          {availableProducts.map((product) => (
            <div key={product.id} className="bg-white rounded-lg overflow-hidden">
              ...
              <div className="p-3 space-y-3">
                ...
                <button
                  onClick={() => { setSelectedProduct(product); posthog.capture('buy_the_look_page_add_to_bag'); }}
